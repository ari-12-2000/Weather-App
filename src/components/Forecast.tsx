...
const Forecast = ({ data, setForecastData }: Props) => {
  ...
  return (
    <div className="w-full py-4 md:max-w-[500px] px-4 lg: h-full lg:h-auto bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg">
       <div className="mx-auto w-[300px]">
      <section className="text-center">
      <h2 className="text-2xl font-black">
            {data.city.name} <span className="font-thin">{data.city.country}</span>
          </h2>
      ...
      <section className="flex overflow-x-scroll mt-4 pb-2 mb-5">
        ...
        <button
          ...
          className="absolute top-0 right-0 text-white bg-gray-800 rounded-md px-3 py-2"
        >
          Back
        </button>
